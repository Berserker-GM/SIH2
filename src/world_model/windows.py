...
def build_state_windows(
    ...
    *this* frame only.
    ...
    out = {
        ...
        "day_id": np.array(day_ids, dtype="U64"),
        "source_file": np.array(source_files, dtype=object),
        "source": np.array(["real"] * len(states), dtype="U16"),
        "persona_id": np.array([""] * len(states), dtype="U64"),
        "run_id": np.array([""] * len(states), dtype="U64"),
